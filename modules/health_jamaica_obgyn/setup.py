#!/usr/bin/env python
# -*- coding: utf-8 -*-
#    Copyright (C) 2016 Ministry of Health - Jamaica
...
requires = [
    ...
    'trytond_health_gyneco' + gnuhealth_version,
]
...
setup(
    ...
    url='http://nhis.moh.gov.jm',
    download_url='http://nhis.moh.gov.jm/pypi/',
