...
name = 'health_disease_notification_history'
prefix = 'trytond_'
...
requires = [
    'trytond_health_disease_notification' + myversion
]

setup(
    name=prefix + name,
    version=info.get('version', '0.0.1'),
    description=info.get('description', 'Disease Notification Audit History'),
