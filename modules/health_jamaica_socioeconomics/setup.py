...
name = 'health_jamaica_socioeconomics'
prefix = 'trytond_'
...
requires = [
    ...
    'trytond_health_socioeconomics' + gnuhealth_version,
    'trytond_health_lifestyle' + gnuhealth_version,
...
setup(
    ...
    description=info.get('description',
                         'Jamaica ePAS Lifestyle and Socioeconomics Module'),
